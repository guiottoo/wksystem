  ...
  return (
    <section id="custos" className="py-28 bg-[#111111]">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white/[0.03] border border-white/[0.07] rounded-lg overflow-hidden">
            <div className="px-6 py-5 border-b border-white/[0.07]">
              <h3 className="text-white font-semibold">Infraestrutura e Hospedagem</h3>
              <p className="text-gray-500 text-xs mt-1 leading-relaxed">Onde o sistema roda e onde os dados ficam armazenados</p>
            </div>
            <div className="divide-y divide-white/[0.05]">
              {infra.map((row) => (
                <div key={row.service} className="flex items-center justify-between px-6 py-4 hover:bg-white/[0.02] transition-colors gap-4">
                  <div className="min-w-0">
                    <div className="text-white text-sm font-medium leading-snug">{row.service}</div>
                    <div className="text-gray-500 text-xs mt-0.5 leading-relaxed">{row.purpose}</div>
                  </div>
                  <span className="text-[#D96C45] text-sm font-semibold whitespace-nowrap flex-shrink-0">{row.range}</span>
                </div>
              ))}
            </div>
            <div className="px-6 py-4 bg-[#D96C45]/5 border-t border-[#D96C45]/15">
              <div className="flex justify-between items-center">
                <span className="text-white font-semibold text-sm">Total estimado</span>
                <span className="text-[#D96C45] font-bold">R$ 244 a R$ 882/mês</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/[0.03] border border-white/[0.07] rounded-lg overflow-hidden">
            <div className="px-6 py-5 border-b border-white/[0.07]">
              <h3 className="text-white font-semibold">Comunicação e Monitoramento</h3>
              <p className="text-gray-500 text-xs mt-1 leading-relaxed">Notificações para clientes e saúde do sistema</p>
            </div>
            <div className="divide-y divide-white/[0.05]">
            ...
            <div className="px-6 py-4 bg-[#D96C45]/5 border-t border-[#D96C45]/15">
              <div className="flex justify-between items-center">
                <span className="text-white font-semibold text-sm">Total estimado</span>
                <span className="text-[#D96C45] font-bold">R$ 50 a R$ 500/mês</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Summary */}
        <div className="bg-gradient-to-br from-[#D96C45]/8 to-transparent border border-[#D96C45]/20 rounded-lg p-8">
          <h3 className="text-white font-bold text-lg mb-6">Resumo Mensal</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              <div className="text-gray-500 text-xs mb-2 uppercase tracking-wide">Infraestrutura</div>
              <div className="text-2xl font-bold text-white leading-tight">R$ 244 a R$ 882</div>
              <div className="text-gray-500 text-xs mt-1">por mês</div>
            </div>
            <div>
              <div className="text-gray-500 text-xs mb-2 uppercase tracking-wide">Comunicação</div>
            ...
            <div className="sm:border-l sm:border-white/10 sm:pl-8">
              <div className="text-gray-500 text-xs mb-2 uppercase tracking-wide">Total operacional</div>
              <div className="text-3xl font-bold text-[#D96C45] leading-tight">R$ 294 a R$ 1.382</div>
              <div className="text-gray-500 text-xs mt-1">por mês</div>
            </div>
          </div>
          <p className="text-gray-600 text-xs mt-8 leading-relaxed border-t border-white/5 pt-5">
