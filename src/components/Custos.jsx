    ...
    <section id="custos" className="section-spacing">
      <div className="site-container">
        <div className="section-header">
          <span className="text-[#D96C45] text-xs font-semibold tracking-widest uppercase inline-block">Operação</span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">Custos Operacionais</h2>
          <p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="card overflow-hidden" style={{padding: 0}}>
            <div className="px-6 sm:px-10 py-7 border-b border-white/[0.07]">
            ...
            <div className="divide-y divide-white/[0.05]">
              {infra.map((row) => (
                <div key={row.service} className="flex items-center justify-between px-6 sm:px-10 py-5 hover:bg-white/[0.02] transition-colors gap-4">
                  ...
                  <span className="text-[#D96C45] text-[15px] font-semibold text-right flex-shrink-0">{row.range}</span>
                </div>
              ))}
            </div>
            <div className="px-6 sm:px-10 py-6 bg-[#D96C45]/5 border-t border-[#D96C45]/15">
        ...
        {/* Summary */}
        <div className="bg-gradient-to-br from-[#D96C45]/8 to-transparent border border-[#D96C45]/20 rounded-lg p-8 sm:p-12" style={{ marginTop: '5rem' }}>
          <h3 className="text-white font-bold text-xl mb-10 text-center">Resumo Mensal</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6 sm:p-8">
              <div className="text-gray-500 text-xs mb-3 uppercase tracking-widest">Infraestrutura</div>
              <div className="text-2xl font-bold text-white leading-tight mb-1">R$ 244 a R$ 882</div>
              <div className="text-gray-500 text-sm">por mês</div>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6 sm:p-8">
              <div className="text-gray-500 text-xs mb-3 uppercase tracking-widest">Comunicação</div>
              <div className="text-2xl font-bold text-white leading-tight mb-1">R$ 50 a R$ 500</div>
              <div className="text-gray-500 text-sm">por mês</div>
            </div>
            <div className="bg-[#D96C45]/8 border border-[#D96C45]/20 rounded-lg p-6 sm:p-8">
              <div className="text-gray-500 text-xs mb-3 uppercase tracking-widest">Total operacional</div>
              <div className="text-2xl font-bold text-[#D96C45] leading-tight mb-1">R$ 294 a R$ 1.382</div>
              <div className="text-gray-500 text-sm">por mês</div>
            </div>
          </div>
