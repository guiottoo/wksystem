...
const languages = [
  {
    lang: 'Português',
    desc: 'Clientes brasileiros e equipe interna',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    lang: 'Inglês',
    desc: 'Clientes de países de língua inglesa e uso internacional',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
      </svg>
  ...
  {
    lang: 'Espanhol',
    desc: 'Clientes da América Latina',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
      </svg>
  ...
  {
    lang: 'Russo',
    desc: 'Clientes de países de língua russa',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
      </svg>
    ...
    <section id="seguranca" className="py-28 bg-[#111111]">
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-3 mb-4">Segurança e Conformidade</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-12">
          {securityItems.map((item) => (
            <div
              key={item.title}
              className="bg-white/[0.03] border border-white/[0.07] rounded-lg p-5 hover:border-[#D96C45]/20 transition-colors"
            >
              <div className="w-9 h-9 rounded-lg bg-[#D96C45]/10 border border-[#D96C45]/20 flex items-center justify-center text-[#D96C45] mb-4">
                {item.icon}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {/* LGPD */}
          <div className="lg:col-span-2 bg-white/[0.03] border border-white/[0.07] rounded-lg p-7">
            <h3 className="text-white font-bold text-lg mb-2">LGPD</h3>
            ...
            <ul className="space-y-3">
              {lgpdItems.map((item) => (
                <li key={item} className="flex items-start gap-3 text-sm text-gray-400 leading-relaxed">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[#D96C45]/15 border border-[#D96C45]/30 flex items-center justify-center mt-0.5">
                    <svg className="w-2.5 h-2.5 text-[#D96C45]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Reliability */}
          <div className="bg-white/[0.03] border border-white/[0.07] rounded-lg p-7">
            <h3 className="text-white font-bold text-lg mb-5">Confiabilidade</h3>
            <div className="space-y-5">
              {reliabilityItems.map((item) => (
                <div key={item.label} className="border-b border-white/5 pb-5 last:border-0 last:pb-0">
                  <div className="text-gray-500 text-xs mb-1">{item.label}</div>
                  <div className="text-[#D96C45] font-bold text-xl leading-tight">{item.value}</div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.07] rounded-lg p-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {languages.map((l) => (
              <div key={l.lang} className="flex items-center gap-3 bg-white/[0.03] border border-white/[0.05] rounded-lg p-4">
                <div className="w-9 h-9 rounded-lg bg-[#D96C45]/10 border border-[#D96C45]/20 flex items-center justify-center text-[#D96C45] flex-shrink-0">
                  {l.icon}
                </div>
                <div>
